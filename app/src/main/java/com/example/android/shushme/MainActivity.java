...
public class MainActivity extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener{
    ...
    protected void onResume() {
        ...
        CheckBox locationPermissionBox = findViewById(R.id.activity_main_permission_cb);
        if (ActivityCompat.checkSelfPermission(
                MainActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            locationPermissionBox.setChecked(false);
        } else {
            locationPermissionBox.setChecked(true);
            locationPermissionBox.setEnabled(false);
        }
    }
    ...
    public void onAddNewLocationClicked(View view) {
        ...
        if (resullt == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(this, "Fine location access denied", Toast.LENGTH_SHORT).show();
        }
    }
